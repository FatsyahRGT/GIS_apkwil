...
<section class="content-header">
  ...
  <section class="content">
    <h4><strong>Tambah Data Kecamatan</strong></h4>

    <div class="card">
        <div class="card-body">
            <?php echo form_open_multipart('KecamatanController/tambah_aksi'); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_kec" id="nama_kec" class="form-control" placeholder="Masukkan Nama Kecamatan" required>
            </div>
