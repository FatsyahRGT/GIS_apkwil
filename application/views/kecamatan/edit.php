<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <?php echo form_open('kecamatan/update/' . $kecamatan->id); ?>
    ...
    <div class="form-group">
        ...
        <select name="id_prov" id="provinsi" class="form-control" required>
            ...
            <?php foreach ($provinsi as $prov): ?>
                <option value="<?= $prov->id ?>" <?= set_select('id_prov', $prov->id, $prov->id == $kecamatan->id_prov); ?>>
                    <?= $prov->nama ?>
                </option>
            <?php endforeach; ?>
        </select>
    ...
    <div class="form-group">
        ...
        <select name="id_kab" id="id_kab" class="form-control" required>
            ...
            <?php foreach ($kabupaten as $kab): ?>
                <option value="<?= $kab->id ?>" <?= set_select('id_kab', $kab->id, $kab->id == $kecamatan->id_kab); ?>>
                    <?= $kab->nama_kabupaten ?>
                </option>
            <?php endforeach; ?>
        </select>
    ...
    <div class="form-group">
        ...
        <input type="text" name="nama_kec" id="nama_kec" class="form-control" placeholder="Masukkan Nama Kecamatan" value="<?= set_value('nama', $kecamatan->nama_kec); ?>" required>
    </div>

    <!-- Kode Dagri -->
    <div class="form-group">
        <label for="kode_dagri">Kode Wilayah Dagri</label>
        <input type="text" name="kode_dagri" id="kode_dagri" class="form-control" placeholder="Masukkan Kode Wilayah Dagri" value="<?= set_value('kode_dagri', $kecamatan->kode_dagri); ?>" required>
    </div>

    <!-- Kode BPS -->
    <div class="form-group">
        <label for="kode_bps">Kode Wilayah BPS</label>
        <input type="text" name="kode_bps" id="kode_bps" class="form-control" placeholder="Masukkan Kode Wilayah BPS" value="<?= set_value('kode_bps', $kecamatan->kode_bps); ?>" required>
    </div>
