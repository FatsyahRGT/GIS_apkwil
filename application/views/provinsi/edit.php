<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <section class="content">
        <h4><strong>EDIT DATA PROVINSI</strong></h4>

        <?php echo form_open('provinsi/update/' . $provinsi->id); ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan Nama Provinsi" value="<?= set_value('nama', $provinsi->nama); ?>" required>
        </div>

        <!-- Kode Dagri -->
        <div class="form-group">
            <label for="kode_dagri">Kode Wilayah Dagri</label>
            <input type="text" name="kode_dagri" id="kode_dagri" class="form-control" placeholder="Masukkan Kode Wilayah Dagri" value="<?= set_value('kode_dagri', $provinsi->kode_dagri); ?>" required>
        </div>

        <!-- Kode BPS -->
        <div class="form-group">
            <label for="kode_bps">Kode Wilayah BPS</label>
            <input type="text" name="kode_bps" id="kode_bps" class="form-control" placeholder="Masukkan Kode Wilayah BPS" value="<?= set_value('kode_bps', $provinsi->kode_bps); ?>" required>
        </div>
