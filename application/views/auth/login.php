...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="card card-outline card-primary">
            ...
            <div class="mt-3">
                <img src="<?= base_url('assets/img/garuda.png') ?>" alt="Logo STIKOM" style="max-width: 100px; max-height: 100px; display: block; margin: 0 auto;">
            </div>
            <div class="card-body">
                <p class="login-box-msg">Masukkan informasi login Anda</p>
