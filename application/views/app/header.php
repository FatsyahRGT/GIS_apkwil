...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>K</b>WH</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Kode</b>Wilayah</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <!-- <img src="<?= base_url('assets/foto/' . ($this->session->userdata('profile_photo') ? $this->session->userdata('profile_photo') : 'default.png')) ?>" class="img-circle" alt="User Image" style="width: 30px; height: 0px;"> -->
              <span class="hidden-xs"><?php echo $this->session->userdata('username') ? $this->session->userdata('username') : 'Guest'; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
              <img src="<?= base_url('assets/foto/' . ($this->session->userdata('profile_photo') ? $this->session->userdata('profile_photo') : 'default.png')) ?>" class="img-circle" alt="User Image" style="width: 50px; height: 50px;">
                <p> 
